            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="mockup-browser border w-full">
                    ...
                    <div className="grid place-content-center h-80 object-cover ">
                        <img src="https://res.cloudinary.com/dbzcqkvnj/image/upload/v1760279652/midhun%20website/jayanthi_hospital.png" alt='hospital image'/>
                    </div>
                    <div>
                ...
                <div className="mockup-browser border w-full">
                    ...
                    <div className="grid place-content-center h-80">
                        <img src="https://res.cloudinary.com/dbzcqkvnj/image/upload/v1760280949/midhun%20website/star_bouncers.png" alt='starbouncers image'/>
                    </div>
                    <div>
                        <div className="p-4 lg:pt-0">
